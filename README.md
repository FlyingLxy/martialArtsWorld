...
想清楚了再动手的东西都写在 [`docs/`](docs/) 里，动手前先看那儿：

| 文档 | 内容 |
|---|---|
| [设计原则](docs/原则.md) | 这游戏该是什么样，什么不能加。**改设计前先过这一关** |
| [经济与成本](docs/经济与成本.md) | 产出与回收的盘点、成本设计、数值膨胀的防线。**动数值前必读** |
| [地图系统](docs/地图系统.md) | 区域划分、六个新机制字段、34 个场景规划 |
| [任务系统](docs/任务系统.md) | 日常与门派任务、任务链、玩家发布的悬赏 |
| [主线剧情《姑存》](docs/首发主线剧情-姑存.md) | 首发主线：从四地旧记录到万国码头，为仍有争议的真相留下证言 |
| [编年史](docs/编年史.md) | 断潮与建港关键年份、历史线索对齐 |
| [术语表](docs/术语表.md) | 玩家可见的标准用词与本地化约束 |
| [活动与秘境](docs/活动与秘境.md) | 定时秘境、门票制、攻防战 |
| [禁地](docs/禁地.md) | 肉鸽副本：三层节点地图、进门选奇物、浅探／深入／绝境 |
| [江湖散人](docs/江湖散人.md) | 人少时撑场面的机器人，以及不能越的线 |
| [落地顺序](docs/落地顺序.md) | 分七期，以及每期为什么排在那儿 |

每篇末尾都有「**待拍板**」，那是还没定的岔路口——定了就把结论写回文档，
别留在聊天记录里。
